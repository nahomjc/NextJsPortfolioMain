  ...
  return (
    <div className="group relative">
      ...
      >
        ...
        <div
          className="absolute -bottom-1.5 right-7 h-2.5 w-2.5 rotate-45 border-b border-r border-cyan-400/40 bg-white dark:border-cyan-500/30 dark:bg-[#0c0818]"
          aria-hidden
        />
      </div>
...
const AIChat = () => {
  ...
  const [messages, setMessages] = useState([
    {
      type: 'bot',
      content: "Hi — I'm Nahom's portfolio assistant. Ask about experience, skills, projects, education, or how to connect.",
    },
  ]);
    ...
    <AnimatePresence>
      ...
      {isOpen && (
        <motion.div
          ...
          className="fixed bottom-4 right-4 z-50 flex h-[min(600px,calc(100dvh-5.5rem))] w-[min(calc(100vw-1.25rem),420px)] flex-col overflow-hidden border border-slate-200/90 bg-white/[0.97] shadow-[0_0_0_1px_rgba(34,211,238,0.12),0_24px_64px_rgba(15,23,42,0.1),0_0_80px_rgba(34,211,238,0.08)] backdrop-blur-2xl dark:border-cyan-500/20 dark:bg-[#07051c]/97 dark:shadow-[0_0_0_1px_rgba(217,70,239,0.12),0_24px_80px_rgba(0,0,0,0.55),0_0_100px_rgba(34,211,238,0.06)] sm:bottom-6 sm:right-6"
          style={{
            clipPath:
        ...
        >
          ...
          <header className="relative flex shrink-0 items-center justify-between gap-3 border-b border-slate-200/90 bg-slate-50/80 px-4 py-3.5 dark:border-white/10 dark:bg-transparent">
            <div className="flex min-w-0 items-center gap-3">
              <div className="relative flex h-10 w-10 shrink-0 items-center justify-center rounded-lg border border-cyan-500/35 bg-cyan-50/90 dark:border-cyan-500/30 dark:bg-black/40">
                ...
                <span
                  className="absolute -bottom-0.5 -right-0.5 h-2 w-2 rounded-full border-2 border-white bg-emerald-500 shadow-[0_0_8px_rgba(52,211,153,0.6)] dark:border-[#07051c] dark:bg-emerald-400 dark:shadow-[0_0_8px_rgba(52,211,153,0.7)]"
                  aria-hidden
                />
              </div>
          ...
          <div className="relative shrink-0 border-t border-slate-200/90 bg-slate-50/70 px-3 py-2.5 dark:border-white/10 dark:bg-black/20">
          ...
          <form
            ...
            className="relative shrink-0 border-t border-slate-200/90 bg-white/60 p-3 dark:border-white/10 dark:bg-transparent sm:p-4"
          >
          ...
          <footer className="relative flex shrink-0 items-center justify-center gap-2 border-t border-slate-200/90 bg-slate-50/90 px-4 py-2.5 dark:border-white/10 dark:bg-black/30">
            <a
