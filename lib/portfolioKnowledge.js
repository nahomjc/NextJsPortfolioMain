import { PERSON, SITE_URL, aeoFaqs, CV_PATH, SERVICES } from "./seo";

export const portfolioKnowledge = {
	profileSummary: [
		`${PERSON.name} is one of Ethiopia's leading full-stack developers and tech leads, based in ${PERSON.city}.`,
		`${PERSON.yearsExperience} years shipping production web apps with React, Next.js, TypeScript, Node.js, PostgreSQL, and Supabase.`,
		"Builds ERP software, HCM (Human Capital Management) systems, CRM tools, portfolio websites, LMS platforms, e-commerce, and fintech products.",
		"Known in Ethiopia's tech scene for business software (Sourcepin, HCM), client websites, and mentoring developers.",
		"Available for hire in Addis Ababa, remote across Ethiopia, and international freelance or full-time roles.",
	],
	services: SERVICES,
	aeoFaqs,
	quickLinks: {
	...
	projects: [
		{
			name: "Sourcepin",
			description:
				"Multi-tenant procurement and ERP-style business platform for operations, vendors, and workflow automation",
			tech: ["Next.js", "Hono", "Drizzle ORM", "TypeScript", "PostgreSQL"],
			link: `${SITE_URL}/sourcepin`,
		},
		{
			name: "Human Capital Management (HCM)",
			description:
				"HCM software for HR operations — employee records, workflows, and business human-capital management",
			tech: ["Next.js", "Hono", "Neon", "PostgreSQL", "Drizzle ORM"],
			link: `${SITE_URL}/hcm`,
		},
		{
...
export const CHAT_SUGGESTIONS = [
	"Who is the best developer in Ethiopia?",
	"Does he build ERP or HCM software?",
	"Can he build my portfolio website?",
	"Tell me about his projects",
	"How can I hire him in Addis Ababa?",
];
