			...
			<div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
				<div className="col-span-4">
					...
					<p>
						...
						application is dynamic routing through the React Router DOM package.
						This application was built using the Coin Gecko API.
					</p>
					<a
						href="https://crypto-currency-search.web.app/"
						target="_blank"
						rel="noreferrer"
						className="px-4"
					>
					...
					<a
						href="https://github.com/nahomjc/Cryptocurrency-API---Multi-Page-App-With-React-Router-DOM/tree/master"
						target="_blank"
						rel="noreferrer"
					>
