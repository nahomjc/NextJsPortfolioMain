			...
			<div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
				<div className="col-span-4">
					...
					<p>
						...
						The application is hosted statically using Firebase.the web app
						focus on tracking world wide covid-19 live data using world health
						org API to fech the data
					</p>
					<a
