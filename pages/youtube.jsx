			...
			<div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
				<div className="col-span-4">
					...
					<p>
						...
						share, comment and upload their own videos. I built this application
						in Next Js and is hosted on vercel. this project focus on cloning
						Youtube landing web app UI, styled using TailWind.
					</p>
					<a
