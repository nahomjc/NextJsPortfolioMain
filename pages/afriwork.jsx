			...
			<div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
				<div className="col-span-4">
					...
					<p>
						...
						participants with the essential skills and confidence needed to
						navigate the job search successfully. Through its accessible online
						platform, Afriwork Learn aims to bridge the gap between job seekers
						and employment opportunities by fostering practical skills
						development.
					</p>
					<a
