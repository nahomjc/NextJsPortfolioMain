		...
		<div className="w-full">
			...
			<div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
				<div className="col-span-4">
					...
					<h2>Overview</h2>
					<p>
						This project is a Netflix clone built using Next.js, Shadcn, and
						Tailwind CSS. It leverages the TMDB API to fetch movie lists and
						allows for movie searching. The project aims to provide streamlined
						access to movies with a fast and smooth user experience. To get
						started, you&apos;ll need Node.js, npm, a TMDB account, and API
						keys. You can clone the repository, install dependencies, add your
						API keys to a .env file, and run the development server to see the
						clone in action. Contributions are welcome, and the project is
