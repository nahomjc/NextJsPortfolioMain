		...
		<div className="w-full">
			<div className="relative h-[30vh] w-screen lg:h-[40vh]">
				...
				<Image
					...
					objectFit="cover"
					src={arHero}
					alt="AR solution trading PLC — digital marketing and web development"
					priority
				/>
				<div className="absolute left-[50%] top-[70%] z-10 w-full max-w-[1240px] translate-x-[-50%] translate-y-[-50%] p-2 text-white">
					...
					<h3 className="text-base font-medium opacity-95 md:text-lg">
						Next.js · TypeScript · Marketing & brand web experience
					</h3>
				</div>
			</div>
			<div className="mx-auto grid max-w-[1240px] gap-8 p-2 pt-8 md:grid-cols-5">
				<div className="col-span-4">
					...
					<p className="mt-4 leading-relaxed text-slate-600 dark:text-slate-400">
						...
						is a{" "}
						<strong className="text-slate-800 dark:text-slate-200">
							digital marketing and trading solutions
						</strong>{" "}
						company in Ethiopia. I contributed as a{" "}
						<strong className="text-slate-800 dark:text-slate-200">
							full-stack engineer
						</strong>{" "}
						on their public site — hero, services, testimonials, and contact
						flows — built with{" "}
						<strong className="text-slate-800 dark:text-slate-200">
							Next.js
						</strong>{" "}
						...
						, emphasizing performance, SEO-friendly structure, and a polished
						brand presentation aligned with their positioning around digital
						strategy, brand development, and web development offerings.
					</p>
					<a
						href="https://www.ar-solutions-plc.com/"
						target="_blank"
