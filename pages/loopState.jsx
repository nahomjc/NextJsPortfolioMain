		...
		<div className="w-full">
			...
			<div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
				<div className="col-span-4">
					...
					<h2>Overview</h2>
					<p>
						Loop facilitates fractional real estate ownership, enabling
						individuals to confidently invest in real estate and build wealth by
						purchasing shares of properties alongside other investors. This
						approach democratizes real estate investment, lowering the barrier
						to entry and allowing for diversified portfolios.
					</p>
					<a
				...
				<div className="col-span-4 md:col-span-1 shadow-xl shadow-gray-400 rounded-xl h-[500px] p-4">
					<div className="p-2">
						...
						<div className="grid grid-cols-3 md:grid-cols-1">
							...
							<p className="text-gray-600 py-2 flex items-center">
								<RiRadioButtonFill className="pr-1" /> Clerk authentication
							</p>
							<p className="text-gray-600 py-2 flex items-center">
